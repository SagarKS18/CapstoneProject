...
<h2>Add New Medicine</h2>
			<form:form action="/admin/product/add" modelAttribute="product" method="post">
                ...
                <div class="form-group">
                    <img src="#" id="imgPreview" height="100px" width="100px" src="/productImages/nike101.jpg" style="margin-top: 20px" alt="Converted Image">
                </div>
...
<script>
 ...
 // Example JSON image data
    var jsonImage = {
      "data": "base64_encoded_image_data",
      "format": "jpeg"
    };

    // Convert JSON image to JPEG and display in HTML
    var imageElement = document.getElementById("imageElement");
    imageElement.src = "data:image/" + jsonImage.format + ";base64," + jsonImage.data;
